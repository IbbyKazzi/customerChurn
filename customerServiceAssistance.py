...
def generate_response(question, data, shap_values, contract_map, df):
    ...
    if "why" in question:
        ...
        response =   (
          ...
          f"These features have the highest SHAP impact on the prediction. Click on the toggle above to view more details."
        )        
        ...
        st.write(styled_row)  # Show highlighted numeric part show all in one green box
